...
class PointerTracker {
  ...
  constructor(_element, callbacks = {}) {
    ...
    this.startPointers = [];
    /**
     * Latest state of the tracked pointers. Contains the same number of
     * pointers, and in the same order as this.startPointers.
     */
    this.currentPointers = [];
    /**
     * Listener for mouse/pointer starts.
     *
     * @param event This will only be a MouseEvent if the browser doesn't
    ...
    this._pointerStart = (event) => {
      ...
      if (isPointerEvent(event)) {
        const capturingElement =
            event.target && 'setPointerCapture' in event.target ? event.target
                                                                : this._element;
