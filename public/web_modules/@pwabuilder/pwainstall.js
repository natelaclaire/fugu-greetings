 ...
 */
const t = new WeakMap, e = e => "function" == typeof e && t.has(e),
      ...
      s = {}, o = {}, r = `{{lit-${String(Math.random()).slice(2)}}}`,
      a = `\x3c!--${r}--\x3e`, l = new RegExp(`${r}|${a}`);
class d {
  constructor(t, e) {
    ...
    for (; d < m;) {
      ...
      if (null !== t) {
        if (a++, 1 === t.nodeType) {
          if (t.hasAttributes()) {
            const e = t.attributes, {length : i} = e;
            let n = 0;
            for (let t = 0; t < i; t++)
              h(e[t].name, "$lit$") && n++;
            for (; n-- > 0;) {
              const e = p[d], i = u.exec(e)[2], n = i.toLowerCase() + "$lit$",
                    s = t.getAttribute(n);
              t.removeAttribute(n);
              const o = s.split(l);
              this.parts.push(
          ...
          const e = t.data;
          if (e.indexOf(r) >= 0) {
            const n = t.parentNode, s = e.split(l), o = s.length - 1;
            for (let e = 0; e < o; e++) {
              let i, o = s[e];
              if ("" === o)
                i = c();
            ...
            "" === s[o] ? (n.insertBefore(c(), t), i.push(t)) : t.data = s[o],
                                                                d += o;
          }
          ...
          if (t.data === r) {
            ...
            null !== t.previousSibling && a !== o ||
                (a++, e.insertBefore(c(), t)),
                o = a, this.parts.push({type : "node", index : a}),
                null === t.nextSibling ? t.data = "" : (i.push(t), a--), d++;
          } else {
            let e = -1;
...
const h =
    (t, e) => {
      ...
      p = t => -1 !== t.index, c = () => document.createComment(""),
...
class m {
  ...
  update(t) {
    ...
    for (const i of this.__parts)
      void 0 !== i && i.setValue(t[e]), e++;
    for (const t of this.__parts)
      void 0 !== t && t.commit();
  }
  _clone() {
    const t = i ? this.template.element.content.cloneNode(!0)
                : document.importNode(this.template.element.content, !0),
          e = [], n = this.template.parts,
    ...
    for (; r < n.length;)
      if (o = n[r], p(o)) {
        for (; a < o.index;)
          a++,
              "TEMPLATE" === l.nodeName &&
                  (e.push(l), s.currentNode = l.content),
              null === (l = s.nextNode()) &&
                  (s.currentNode = e.pop(), l = s.nextNode());
        if ("node" === o.type) {
          ...
          this.__parts.push(...this.processor.handleAttributeExpressions(
              l, o.name, o.strings, this.options));
        r++;
      } else
...
class g {
  ...
  getHTML() {
    ...
    let e = "", i = !1;
    for (let n = 0; n < t; n++) {
      const t = this.strings[n], s = t.lastIndexOf("\x3c!--");
...
class x {
  constructor(t, e, i) {
    this.dirty = !0, this.element = t, this.name = e, this.strings = i,
    this.parts = [];
    for (let t = 0; t < i.length - 1; t++)
      this.parts[t] = this._createPart();
  }
  _createPart() { return new _(this) }
  _getValue() {
...
class b {
  ...
  insertAfterPart(t) {
    t.__insert(this.startNode = c()), this.endNode = t.endNode,
    ...
    t !== s &&
        (y(t) ? t !== this.value && this.__commitText(t)
              : t instanceof g
                    ...
                    : t instanceof Node
                          ? this.__commitNode(t)
                          : v(t) ? this.__commitIterable(t)
                                 : t === o ? (this.value = o, this.clear())
                                           : this.__commitText(t));
  }
  ...
  __commitTemplateResult(t) {
    ...
    if (this.value instanceof m && this.value.template === e)
      ...
      const i = new m(e, t.processor, this.options), n = i._clone();
  ...
  __commitIterable(t) {
    ...
    for (const s of t)
      i = e[n],
      void 0 === i &&
          (i = new b(this.options), e.push(i),
           0 === n ? i.appendIntoPart(this) : i.insertAfterPart(e[n - 1])),
      i.setValue(s), i.commit(), n++;
...
class w {
  constructor(t, e, i) {
    if (this.value = void 0, this.__pendingValue = void 0,
        2 !== i.length || "" !== i[0] || "" !== i[1])
      throw new Error(
  ...
  commit() {
    ...
    if (this.__pendingValue === s)
      return;
    const t = !!this.__pendingValue;
    this.value !== t && (t ? this.element.setAttribute(this.name, "")
...
let P = !1;
try {
  const t = {get capture() { return P = !0, !1 }};
...
class k {
  constructor(t, e, i) {
    this.value = void 0, this.__pendingValue = void 0, this.element = t,
    this.eventName = e, this.eventContext = i,
  ...
  commit() {
    ...
    if (this.__pendingValue === s)
      return;
    const t = this.__pendingValue, i = this.value,
          n = null == t ||
              null != i && (t.capture !== i.capture || t.once !== i.once ||
                            t.passive !== i.passive),
          o = null != t && (null == i || n);
    n && this.element.removeEventListener(
        ...
        o && (this.__options = N(t),
              this.element.addEventListener(
                  this.eventName, this.__boundHandleEvent, this.__options)),
        this.value = t, this.__pendingValue = s;
  }
  handleEvent(t) {
...
const E = new class {
  handleAttributeExpressions(t, e, i, n) {
    const s = e[0];
    if ("." === s) {
      return new S(t, e.slice(1), i).parts
    }
    return "@" === s
               ? [ new k(t, e.slice(1), n.eventContext) ]
               : "?" === s ? [ new w(t, e.slice(1), i) ] : new x(t, e, i).parts
  }
...
function T(t) {
  let e = A.get(t.type);
  void 0 === e &&
      (e = {stringsArray : new WeakMap, keyString : new Map}, A.set(t.type, e));
  ...
  return i = e.keyString.get(n),
         void 0 === i &&
             (i = new d(t, t.getTemplateElement()), e.keyString.set(n, i)),
         e.stringsArray.set(t.strings, i), i
}
const A = new Map, $ = new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
const B = (t, ...e) => new g(t, e, "html", E)
    ...
    ;
function V(t, e) {
  const {element : {content : i}, parts : n} = t, s = document.createTreeWalker(
                                                      i, 133, null, !1);
  let o = O(n), r = n[o], a = -1, l = 0;
  const d = [];
  let h = null;
  for (; s.nextNode();) {
    a++;
    ...
    for (t.previousSibling === h && (h = null),
         e.has(t) && (d.push(t), null === h && (h = t)), null !== h && l++;
         void 0 !== r && r.index === a;)
      r.index = null !== h ? -1 : r.index - l, o = O(n, o), r = n[o];
  }
...
const R =
    t => e => {
      ...
      let n = A.get(i);
      void 0 === n &&
          (n = {stringsArray : new WeakMap, keyString : new Map}, A.set(i, n));
      let s = n.stringsArray.get(e.strings);
      if (void 0 !== s)
        return s;
      const o = e.strings.join(r);
      if (s = n.keyString.get(o), void 0 === s) {
        const i = e.getTemplateElement();
        j && window.ShadyCSS.prepareTemplateDom(i, t), s = new d(e, i),
                                                       n.keyString.set(o, s);
      }
      return n.stringsArray.set(e.strings, s), s
    },
      U = [ "html", "svg" ], L = new Set,
      I =
          (t, e, i) => {
            L.add(t);
            const n = i ? i.element : document.createElement("template"),
                  s = e.querySelectorAll("style"), {length : o} = s;
            if (0 === o)
            ...
            (t => {
              U.forEach(e => {
                ...
                void 0 !== i && i.keyString.forEach(t => {
                  const {element : {content : e}} = t, i = new Set;
            ...
            const a = n.content;
            i?function(t,e,i=null){const{element:{content:n},parts:s}=t;if(null==i)return void n.appendChild(e);const o=document.createTreeWalker(n,133,null,!1);let r=O(s),a=0,l=-1;for(;o.nextNode();){for(l++,o.currentNode===i&&(a=M(e),i.parentNode.insertBefore(e,i));-1!==r&&s[r].index===l;){if(a>0){for(;-1!==r;)s[r].index+=a,r=O(s,r);return}r=O(s,r);}}}(i,r,a.firstChild):a.insertBefore(r,a.firstChild),window.ShadyCSS.prepareTemplateStyles(n,t);
...
class H extends HTMLElement {
  constructor() {
    super(), this._updateState = 0, this._instanceProperties = void 0,
             this._updatePromise = W, this._hasConnectedResolver = void 0,
  ...
  static createProperty(t, e = q) {
    if (this._ensureClassProperties(), this._classProperties.set(t, e),
    ...
    Object.defineProperty(this.prototype, t, {
      ...
      set(e) {
        const n = this[t];
        this[i] = e, this._requestUpdate(t, n);
      },
      configurable : !0,
      enumerable : !0
    });
  ...
  static finalize() {
    ...
    if (t.hasOwnProperty("finalized") || t.finalize(), this.finalized = !0,
        this._ensureClassProperties(), this._attributeToPropertyMap = new Map,
  ...
  static _attributeNameForProperty(t, e) {
    ...
    return !1 === i ? void 0
                    : "string" == typeof i
                          ? i
                          : "string" == typeof t ? t.toLowerCase() : void 0
  }
  static _valueHasChanged(t, e, i = D) { return i(t, e) }
  static _propertyValueFromAttribute(t, e) {
    const i = e.type, n = e.converter || F,
  ...
  static _propertyValueToAttribute(t, e) {
    if (void 0 === e.reflect)
      return;
    const i = e.type, n = e.converter;
    return (n && n.toAttribute || F.toAttribute)(t, i)
  }
  ...
  _propertyToAttribute(t, e, i = q) {
    const n = this.constructor, s = n._attributeNameForProperty(t, i);
    if (void 0 !== s) {
  ...
  _attributeToProperty(t, e) {
    if (8 & this._updateState)
      return;
    const i = this.constructor, n = i._attributeToPropertyMap.get(t);
    if (void 0 !== n) {
      const t = i._classProperties.get(n) || q;
  ...
  _requestUpdate(t, e) {
    let i = !0;
    if (void 0 !== t) {
      const n = this.constructor, s = n._classProperties.get(t) || q;
  ...
  async _enqueueUpdate() {
    ...
    this._updatePromise = new Promise((i, n) => { t = i, e = n; });
    try {
      await i;
    } catch (t) {
    }
  ...
  update(t) {
    void 0 !== this._reflectingProperties &&
        ...
        (this._reflectingProperties.forEach(
             (t, e) => this._propertyToAttribute(e, this[e], t)),
...
const J = (t, e) =>
    "method" === e.kind && e.descriptor && !("value" in e.descriptor)
        ? Object.assign({}, e, {finisher(i) { i.createProperty(e.key, t); }})
        : {
            kind : "field",
            key : Symbol(),
            placement : "own",
            ...
            finisher(i) { i.createProperty(e.key, t); }
          };
function Y(t) {
  return (e, i) => void 0 !== i
...
*/
const K = "adoptedStyleSheets" in Document.prototype &&
...
class G {
  ...
  get styleSheet() {
    return void 0 === this._styleSheet &&
               (K ? (this._styleSheet = new CSSStyleSheet,
          ...
          e + (t => {
            ...
            throw new Error(
                `Value passed to 'css' function must be a 'css' function result: ${
                    t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)
          })(i) +
          t[n + 1],
      t[0]);
  return new G(i, Z)
...
const X = t => t.flat ? t.flat(1 / 0) : function t(e, i = []) {
  for (let n = 0, s = e.length; n < s; n++) {
    const s = e[n];
    Array.isArray(s) ? t(s, i) : i.push(s);
  }
  return i
}(t);
class tt extends H {
  ...
  static _getUniqueStyles() {
    ...
    if (Array.isArray(t)) {
      X(t).reduceRight((t, e) => (t.add(e), t), new Set)
  ...
  adoptStyles() {
    ...
    0 !== t.length &&
        (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow
             ? K ? this.renderRoot.adoptedStyleSheets = t.map(t => t.styleSheet)
                 : this._needsShimAdoptedStyleSheets = !0
             : window.ShadyCSS.ScopingShim.prepareAdoptedCssText(
                   t.map(t => t.cssText), this.localName));
  }
  connectedCallback() {
    super.connectedCallback(), this.hasUpdated && void 0 !== window.ShadyCSS &&
                                   window.ShadyCSS.styleElement(this);
  }
  update(t) {
    super.update(t);
    const e = this.render();
    e instanceof g && this.constructor.render(
                          e, this.renderRoot,
...
tt.finalized = !0, tt.render = (t, e, i) => {
  ...
  const s = i.scopeName, o = $.has(e), r = j && 11 === e.nodeType && !!e.host,
        a = r && !L.has(s), l = a ? document.createDocumentFragment() : e;
  if (((t, e, i) => {
        let s = $.get(e);
        void 0 === s &&
            (n(e, e.firstChild),
             $.set(e, s = new b(Object.assign({templateFactory : T}, i))),
             s.appendInto(e)),
            s.setValue(t), s.commit();
      })(t, l, Object.assign({templateFactory : R(s)}, i)),
      a) {
    const t = $.get(l);
    $.delete(l);
    const i = t.value instanceof m ? t.value.template : void 0;
    I(s, l, i), n(e, e.firstChild), e.appendChild(l), $.set(e, t);
  }
...
var et = function(t, e, i, n) {
  var s, o = arguments.length,
         r = o < 3 ? e
                   : null === n ? n = Object.getOwnPropertyDescriptor(e, i) : n;
...
let it = class extends tt {
  constructor() {
    super(),
        this.manifestpath = "manifest.json", this.openmodal = !1,
        this.hasprompt = !1,
        this.explainer =
        ...
        this.installbuttontext = "Install", this.cancelbuttontext = "Cancel",
  ...
  checkManifest(t) {
    t.icons && t.icons[0]
        ? t.name ? t.description ||
                       console.error(
                           "Your web manifest must have a description listed")
  ...
  async getManifestData() {
    try {
      const t = await fetch(this.manifestpath), e = await t.json();
      if (this.manifestdata = e, this.manifestdata)
        return this.updateButtonColor(this.manifestdata),
               this.checkManifest(this.manifestdata), e
    } catch (t) {
      return null
    }
  }
  updateButtonColor(t) {
    t.theme_color &&
        this.style.setProperty("--install-button-color", t.theme_color);
  }
  scrollToLeft() {
    this.shadowRoot.querySelector("#screenshots")
        .scrollBy({left : -15, top : 0, behavior : "smooth"});
  }
  scrollToRight() {
    this.shadowRoot.querySelector("#screenshots")
        .scrollBy({left : 15, top : 0, behavior : "smooth"});
  ...
  shouldShowInstall() {
    return this.isSupportingBrowser || this.hasprompt || this.isIOS
  }
  async install() {
  ...
  cancel() {
    return new Promise((t, e) => {
      this.openmodal = !1,
      this.hasAttribute("openmodal") && this.removeAttribute("openmodal");
  ...
  render() {
    return B`${
        !0 !== this.usecustom && this.shouldShowInstall() &&
                !1 === this.installed
            ? B`<button part=openButton id=openButton @click=${
                  () => this.openPrompt()}><slot>${
                  this.installbuttontext}</slot></button>`
            : null} ${
        !0 === this.openmodal
            ? B`<div id=installModalWrapper>${
                  this.openmodal
                      ? B`<div id=background @click=${
                            () => this.cancel()}></div>`
                      : null}<div id=installModal part=installModal><div id=headerContainer><div id=logoContainer><img src=${
                  this.iconpath
                      ? this.iconpath
                      : this.manifestdata.icons[0]
                            .src} alt="App Logo"><div id=installTitle><h1>${
                  this.manifestdata.short_name ||
                  this.manifestdata.name}</h1><p id=desc>${
                  this.explainer}</p></div></div><button id=closeButton @click=${
                  () =>
                      this.cancel()}><svg width=23 height=22 viewBox="0 0 23 22" fill=none xmlns=http://www.w3.org/2000/svg><path opacity=0.33 fill-rule=evenodd clip-rule=evenodd d="M1.11932 0.357981C1.59693 -0.119327 2.37129 -0.119327 2.8489 0.357981L11.7681 9.27152L20.6873 0.357981C21.165 -0.119327 21.9393 -0.119327 22.4169 0.357981C22.8945 0.835288 22.8945 1.60916 22.4169 2.08646L13.4977 11L22.4169 19.9135C22.8945 20.3908 22.8945 21.1647 22.4169 21.642C21.9393 22.1193 21.165 22.1193 20.6873 21.642L11.7681 12.7285L2.8489 21.642C2.37129 22.1193 1.59693 22.1193 1.11932 21.642C0.641705 21.1647 0.641705 20.3908 1.11932 19.9135L10.0385 11L1.11932 2.08646C0.641705 1.60916 0.641705 0.835288 1.11932 0.357981Z" fill=#60656D /></svg></button></div><div id=contentContainer><div id=featuresScreenDiv>${
                  this.manifestdata.features
                      ? B`<div id=keyFeatures><h3>${
                            this.featuresheader}</h3><ul>${
                            this.manifestdata.features
                                ? this.manifestdata.features.map(
                                      t => B`<li>${t}</li>`)
                                : null}</ul></div>`
                      : null} ${
                  this.manifestdata.screenshots
                      ? B`<div id=screenshotsContainer><button @click=${
                            () =>
                                this.scrollToLeft()}><svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 512 512"><path d="M401.4 224h-214l83-79.4c11.9-12.5 11.9-32.7 0-45.2s-31.2-12.5-43.2 0L89 233.4c-6 5.8-9 13.7-9 22.4v.4c0 8.7 3 16.6 9 22.4l138.1 134c12 12.5 31.3 12.5 43.2 0 11.9-12.5 11.9-32.7 0-45.2l-83-79.4h214c16.9 0 30.6-14.3 30.6-32 .1-18-13.6-32-30.5-32z"/></svg></button><section id=screenshots>${
                            this.manifestdata.screenshots.map(
                                t => B`<div><img alt="App Screenshot" src=${
                                    t.src}></div>`)}</section><button @click=${
                            () =>
                                this.scrollToRight()}><svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 512 512"><path d="M284.9 412.6l138.1-134c6-5.8 9-13.7 9-22.4v-.4c0-8.7-3-16.6-9-22.4l-138.1-134c-12-12.5-31.3-12.5-43.2 0-11.9 12.5-11.9 32.7 0 45.2l83 79.4h-214c-17 0-30.7 14.3-30.7 32 0 18 13.7 32 30.6 32h214l-83 79.4c-11.9 12.5-11.9 32.7 0 45.2 12 12.5 31.3 12.5 43.3 0z"/></svg></button></div>`
                      : null}</div><div id=descriptionWrapper><h3>${
                  this.descriptionheader}</h3><p>${
                  this.manifestdata.description}</p></div></div>${
                  this.isIOS
                      ? B`<p id=iosText>${this.iosinstallinfotext}</p>`
                      : B`<div id=buttonsContainer>${
                            this.deferredprompt
                                ? B`<button id=installButton @click=${
                                      () => this.install()}>${
                                      this.installbuttontext} ${
                                      this.manifestdata.short_name}</button>`
                                : B`<button @click=${
                                      () =>
                                          this.cancel()} id=installCancelButton>${
                                      this.cancelbuttontext}</button>`}</div>`}</div></div>`
            : null}`
  }
};
var nt;
et([ Y({type : String}) ], it.prototype, "manifestpath", void 0),
    et([ Y({type : String}) ], it.prototype, "iconpath", void 0),
    et([ Y({type : Object}) ], it.prototype, "manifestdata", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "openmodal", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "showopen", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "isSupportingBrowser", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "isIOS", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "installed", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "hasprompt", void 0),
    et([ Y({type : Boolean}) ], it.prototype, "usecustom", void 0),
    et([ Y({type : String}) ], it.prototype, "explainer", void 0),
    et([ Y({type : String}) ], it.prototype, "featuresheader", void 0),
    et([ Y({type : String}) ], it.prototype, "descriptionheader", void 0),
    et([ Y({type : String}) ], it.prototype, "installbuttontext", void 0),
    et([ Y({type : String}) ], it.prototype, "cancelbuttontext", void 0),
    et([ Y({type : String}) ], it.prototype, "iosinstallinfotext", void 0),
    et([ Y() ], it.prototype, "deferredprompt", void 0),
    it = et(
        [ (nt = "pwa-install",
           t => "function" == typeof t
                    ? ((t, e) => (window.customElements.define(t, e), e))(nt, t)
                    : ((t, e) => {
